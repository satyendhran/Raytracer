...
def near_zero_vec3(v: ti.math.vec3):
    ...
    """
    s = 1e-8  # Threshold for near-zero comparison
...
class Material:
    ...
    Attributes:
        ...
        albedo: Surface color/reflectance [0, 1] for each RGB channel
    ...
    def scatter(self, r_in, rec, attenuation, scattered, i, j):
        ...
        Args:
            r_in: Incoming ray
            rec: Hit record containing intersection information
